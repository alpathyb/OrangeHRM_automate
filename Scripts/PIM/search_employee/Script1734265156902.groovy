...
WebUI.click(findTestObject('Object Repository/PIM_Page/Result_List_Fajar'))

WebUI.verifyElementPresent(findTestObject('Object Repository/PIM_Page/h6_Fajar_tittle'), 1)
